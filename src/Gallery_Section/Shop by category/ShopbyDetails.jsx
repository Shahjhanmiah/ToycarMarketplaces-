...
const ShopbyDetails = ({ toy }) => {
    const { toy_name, _id, image, toy_type, color, price, Rating } = toy
    return (
        <div>
            <div className="max-w-xs rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    ...
                    <button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracki rounded-md bg-orange-500 ">Read more</button>
                </div>
            </div>
        </div>
    );
